...
type TeamsViewProps = ReturnType<typeof useTeamsModel>;

export const TeamsView = (props: TeamsViewProps) => {
  const {
    isAdmin,
    isGerente,
    isLoading,
                ...
                <div key={team.id} className="card overflow-hidden">
                  <div className="p-5 flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <div className="flex items-center gap-4 flex-1 min-w-0">
                      <div
                        className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 ${avatarColor(team.name)}`}
                      >
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      <button
                        onClick={() =>
                          setExpandedTeam(expanded ? null : team.id)
                        }
                      ...
                      {isAdmin && (
                        <>
                          ...
                          <button
                            onClick={() =>
                              setDeleteConfirm(
                                deleteConfirm === team.id ? null : team.id,
                              )
                            }
                  ...
                  {deleteConfirm === team.id && (
                    <div className="border-t border-rose-100 bg-rose-50 px-5 py-3 flex items-center justify-between gap-4">
                      <p className="text-sm text-rose-700">
                        Remover <strong>{team.name}</strong>? Esta ação não pode
                        ser desfeita.
                      </p>
