...
import { UpdateNegotiationService } from '../../../../modules/leads/controllers/UpdateNegotiationController';


const leadsRoutes = Router();
const updateNegotiationController = new UpdateNegotiationService();
...
leadsRoutes.put('/negotiations/:id', ensureAuthenticated, updateNegotiationController.execute);
