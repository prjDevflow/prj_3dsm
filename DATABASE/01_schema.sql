-- Schema idêntico ao gerado pelas migrations do Prisma
-- (20260413231753_init_db + 20260501000000_fix_schema_drift)
...
-- Migration 2: ajustes de schema
ALTER TABLE "leads" DROP COLUMN IF EXISTS "id_status";
ALTER TABLE "leads" DROP COLUMN IF EXISTS "data_atualizacao_lead";
...
ALTER TABLE "usuarios"
    ...
    ADD CONSTRAINT "usuarios_id_equipe_fkey" FOREIGN KEY ("id_equipe") REFERENCES "equipes"("id_equipe") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "leads"
    ADD CONSTRAINT "leads_id_cliente_fkey"  FOREIGN KEY ("id_cliente") REFERENCES "clientes"("id_cliente") ON DELETE RESTRICT ON UPDATE CASCADE,
    ADD CONSTRAINT "leads_id_usuario_fkey"  FOREIGN KEY ("id_usuario") REFERENCES "usuarios"("id_usuario") ON DELETE RESTRICT ON UPDATE CASCADE,
    ADD CONSTRAINT "leads_id_loja_fkey"     FOREIGN KEY ("id_loja")    REFERENCES "lojas"("id_loja")    ON DELETE RESTRICT ON UPDATE CASCADE,
    ADD CONSTRAINT "leads_id_origem_fkey"   FOREIGN KEY ("id_origem")  REFERENCES "origens"("id_origem")  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "negociacoes"
    ADD CONSTRAINT "negociacoes_id_lead_fkey"    FOREIGN KEY ("id_lead")    REFERENCES "leads"("id_lead")       ON DELETE RESTRICT ON UPDATE CASCADE,
    ADD CONSTRAINT "negociacoes_id_estagio_fkey" FOREIGN KEY ("id_estagio") REFERENCES "estagios"("id_estagio") ON DELETE RESTRICT ON UPDATE CASCADE,
    ADD CONSTRAINT "negociacoes_id_status_fkey"  FOREIGN KEY ("id_status")  REFERENCES "status"("id_status")   ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "historicos_negociacoes"
    ADD CONSTRAINT "historicos_negociacoes_id_negociacao_fkey" FOREIGN KEY ("id_negociacao") REFERENCES "negociacoes"("id_negociacao") ON DELETE RESTRICT ON UPDATE CASCADE,
    ADD CONSTRAINT "historicos_negociacoes_id_usuario_fkey"    FOREIGN KEY ("id_usuario")    REFERENCES "usuarios"("id_usuario")    ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "logs_operacoes"
    ADD CONSTRAINT "logs_operacoes_id_usuario_fkey" FOREIGN KEY ("id_usuario") REFERENCES "usuarios"("id_usuario") ON DELETE RESTRICT ON UPDATE CASCADE;
